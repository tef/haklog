...
unify(E,Eo,[p(P,A)|Lt],R) :-  !, unify_p_l(P,E,Eo,A,Lt,R).
unify(E,Eo,L,[p(P,A)|Rt]) :-  !, unify_p_l(P,E,Eo,A,Rt,L).
unify(E,Eo,[Ho|To],[H|T]) :-!,unify(E,E1,Ho,H),unify(E1,Eo,To,T).

unify(E,Eo,p(P,A),R) :-  !, unify_p_l(P,E,Eo,A,[],R).
unify(E,Eo,L,p(P,A)) :-  !, unify_p_l(P,E,Eo,A,[],L).
...
unify_p_l(P,E,Eo,A,Lt,[Ip|T]) :- \+var(Ip), Ip=p(Pi,Ai),!,unify_p_l(Pi,E,E1,Ai,At,V),  append(At,Lo,Lt), (V=[]->(!,fail)),append(V,Ot,A),  unify_p_l(P,E1,Eo,Ot,Lo,T).
...
unify_p_l(any,E,E,[],T,T).
unify_p_l(zany,E,E,[],T,T).
...
unify_p_l(maybe,E,E,_,T,T).
unify_p_l(zmaybe,E,E,_,T,T).
unify_p_l(zmaybe,E,Eo,A,T,[H|T]) :- unify(E,Eo,A,H).
